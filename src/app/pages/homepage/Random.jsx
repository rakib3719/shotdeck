...
function Random() {
  ...
  const query = {
    ...
    ...(sortBy && { sortBy }),
    limit: 100, // Fetch more to have enough for random selection
  };
                    ...
                    <SwiperSlide key={shot._id}>
                      ...
                      >
                        ...
                        <div className="h-1/2 p-4 overflow-y-auto">
                          ...
                          <button
                            className="mt-4 text-xs px-3 py-2 bg-blue-600 hover:bg-blue-700 rounded self-start transition-colors w-full"
                            onClick={(e) => {
                              e.stopPropagation();
