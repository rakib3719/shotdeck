...
import { FiUpload, FiFilm, FiYoutube, FiImage, FiPlus, FiX, FiClock } from 'react-icons/fi';
import { FaPalette, FaCamera, FaLightbulb, FaUser } from 'react-icons/fa';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="flex">
                  <input
                    ...
                    className="flex-1 bg-gray-700 border border-gray-600 rounded-l-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="https://example.com/image.jpg"
                  />
                  <button
                    type="button"
                    className="bg-blue-600 hover:bg-blue-700 px-4 rounded-r-md flex items-center"
                  >
                    <FiUpload className="mr-1" /> Upload
                  </button>
                </div>
                {errors.imageUrl && <p className="mt-1 text-sm text-red-400">Image URL is required</p>}
              </div>
              ...
              <div>
                ...
                <div className="flex">
                  ...
                  <button
                    type="button"
                    className="bg-red-600 hover:bg-red-700 px-4 rounded-r-md flex items-center"
                  >
                    <FiYoutube className="mr-1" /> Link
                  </button>
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="w-24 bg-gray-700 border border-gray-600 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="#RRGGBB"
                  />
